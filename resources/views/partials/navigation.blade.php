                    ...
                    <div class="dropdown-menu-scrollable pb-2">
                        <a href="#" class="dropdown-item align-items-start text-wrap py-2">
                            <div class="status-indicator-container me-3">
                                <img src="assets/images/demo/users/face10.jpg" class="w-40px h-40px rounded-pill"
                                    alt="">
                ...
                <div class="form-control-feedback form-control-feedback-start flex-grow-1" data-color-theme="dark">
                    ...
                    <div class="dropdown-menu w-100" data-color-theme="light">
                        ...
                        <div class="dropdown-menu-scrollable-lg">
                            ...
                            <div class="dropdown-item cursor-pointer">
                                <div class="me-3">
                                    <img src="https://themes.kopyov.com/limitless/demo/template/assets/images/brands/adobe.svg"
                            ...
                            <div class="dropdown-item cursor-pointer">
                                <div class="me-3">
                                    <img src="https://themes.kopyov.com/limitless/demo/template/assets/images/brands/holiday-inn.svg"
                                        class="w-32px h-32px rounded-pill" alt="">
                                </div>
                            ...
                            <div class="dropdown-item cursor-pointer">
                                <div class="me-3">
                                    <img src="https://themes.kopyov.com/limitless/demo/template/assets/images/brands/ing.svg"
                                        class="w-32px h-32px rounded-pill" alt="">
                                </div>
